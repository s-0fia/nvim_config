...
vim.keymap.set("n", "<C-j>", ":cnext<CR>", { desc = "Goto next quickfix" })
vim.keymap.set("n", "<C-k>", ":cprev<CR>", { desc = "Goto previous quickfix" })
...
local run_proj = function()
    ...
    vim.api.nvim_feedkeys("<c-w>v:term<cr>i" .. what_to_do .. "<cr>", "m", false)
end
